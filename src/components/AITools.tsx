        ...
        <CardContent className="p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="opacity-90">Explore the power of artificial intelligence</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <TabsContent value="text">
          <Card className="border-0 bg-white/70 backdrop-blur-sm dark:bg-gray-900/70">
            <CardHeader>
              ...
              <CardDescription>
                Generate original content powered by AI
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Textarea
                placeholder="Write your personal journal about your day..."
                value={textPrompt}
        ...
        <TabsContent value="voice">
          <Card className="border-0 bg-white/70 backdrop-blur-sm dark:bg-gray-900/70">
            <CardHeader>
              ...
              <CardDescription>
                Convert your text into natural-sounding audio
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Textarea
        ...
        <TabsContent value="image">
          <Card className="border-0 bg-white/70 backdrop-blur-sm dark:bg-gray-900/70">
            <CardHeader>
              ...
              <CardDescription>
                Create unique images from your descriptions
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Textarea
                placeholder="Describe the image you want to create (e.g. A mountain landscape at sunset with golden clouds)..."
                value={imagePrompt}
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-orange-900 dark:text-orange-100">AI powered by OpenAI</p>
                <p className="text-sm text-orange-700 dark:text-orange-300">
                  State-of-the-art technology for an exceptional user experience
                </p>
              </div>
            </div>
